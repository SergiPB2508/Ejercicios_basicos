...
let position1 = rickAndMortyCharacters1.length - 1;

console.log(rickAndMortyCharacters1[position1]);
...
let position2 = rickAndMortyCharacters2.length - 1;

console.log(`Primero: ${rickAndMortyCharacters2[0]}`);
console.log(`Ultimo: ${rickAndMortyCharacters2[position2]}`);
